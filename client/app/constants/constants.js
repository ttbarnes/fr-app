...
export const API_COLLABORATORS = 'http://localhost:4040/graphql?query={collaborators{name, role, avatarUrl, orderNumber, urlName, about, urls{website,facebook,instagram,twitter,soundcloud,bandcamp,bio,email,phone}, collabOn}}';
