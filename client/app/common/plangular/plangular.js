//wrap plangular directive in our own module.
//ideally we could extract the actual plangular directive into it's own component, eg:
//
//.component('plangular', importedModule)
//
//however some plangular refactoring is required in order to achieve this.

import angular from 'angular';
import uiRouter from 'angular-ui-router';

let plangularModule = angular.module('plangular', [
  uiRouter
])
...
export default plangularModule